  ...
  return (
    <>
      ...
      <section className="py-20 sm:py-28">
        <Container>
          <AnimatedSection className="mx-auto max-w-3xl space-y-6 text-lg leading-relaxed text-stone-700">
            <p>
              Tawakul Foundation is a Muslim charitable organization founded in
              December 2025 and based in Busia, Western Kenya. Our mission is to
              make a meaningful difference in the lives of vulnerable members of
              our communities, particularly orphans, widows, elderly people, and
            ...
            <p>
              ...
              Through fundraising initiatives, charitable visits, and community
              projects, we work to ensure that generosity reaches those who need
              it most.
            </p>
            <p>
              ...
              experience strengthened our commitment to continuing this work and
            ...
            <AnimatedSection delay={0.2}>
              <div className="rounded-2xl border border-green-100 bg-white p-8 text-center shadow-sm">
                ...
                <p className="mt-3 text-stone-600">
                  ...
                  serve as a transparent bridge between generous donors and the
                  communities who need their support most.
                </p>
              </div>
            </AnimatedSection>
          </div>
